...
; Library data
; 
; Includes all initialization for the used library (neslib with famitracker)
;

.include "./neslib-system.asm"
.include "./neslib.asm"
.include "./library/patchable_data.asm"
...
music_data:
	; .bin file, as generated by famitracker through the export menu (5549)
    .incbin "../../sound/music.bin"
    ; Slightly more space, as the tool expects to have a bit more.
    .res 4691, $ff
