...
s3_upload:
	mc cp ./rom/starter.nes  s3/cpprograms-nes-games-https/retro-puzzle-maker-v2-3.nes && mc policy public s3/cpprograms-nes-games-https/retro-puzzle-maker-v2-3.nes
